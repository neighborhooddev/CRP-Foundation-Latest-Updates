...
// - SetSpawnInfo
// - SpawnPlayer
// - Status Register Spawn
//
// UI:
// crp_register_spawn_textdraw.pwn
//
// Digunakan setelah:
// Character Creation
//
// NANTI:
// Register Spawn hanya untuk karakter baru.
// ============================================================
...
if (  
    spawnid < REGISTER_SPAWN_UNITY ||  
    spawnid > REGISTER_SPAWN_EAST  
)  
{  
    SendClientMessage(  
        playerid,  
...
{
print("---------------------------------------");
print(" CRP Register Spawn System v0.3");
